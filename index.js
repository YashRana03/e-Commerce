...
function addToCart(e, itemId) {
  ...
  if (!alredyInCart) {
    ...
    removeProductEl.addEventListener("click", (e) => {
      ...
      cartTotal -=
        everything[e.target.parentElement.parentElement.id].price *
        productCount[e.target.parentElement.parentElement.id];
    ...
    chevronUpEl.addEventListener("click", (e) => {
      ...
      e.target.parentElement.querySelector(".product-counter").textContent =
        productCount[e.target.parentElement.parentElement.id];
